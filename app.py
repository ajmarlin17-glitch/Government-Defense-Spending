...
st.markdown(
    ...
    div[data-testid="stRadio"] div[role="radiogroup"] {{ gap: 4px; border-bottom: 2px solid {GREY_LIGHT}; }}
...
with st.sidebar:
    ...
    category_fy = st.selectbox("Fiscal year (Spending categories / TEC relevance)", category_years, key="category_fy")
