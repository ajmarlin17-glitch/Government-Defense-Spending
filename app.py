...
# --- Header: eyebrow, title, subtitle, brand tagline ---
...
st.write("")
tab_chart, tab_table, tab_categories, tab_tec = st.tabs(
    ["Trend chart", "Data table", "Spending categories", "TEC relevance"]
)
...
with tab_tec:
    ...
    st.caption(
        ...
        "Fiscal year is set by the selector on the Spending categories tab."
    )
